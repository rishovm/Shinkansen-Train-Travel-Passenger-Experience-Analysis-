...
THIS WAS A HACKATHON ORGANISED BY GREAT LEARNING IN COLLABORATION WITH MIT PROFESSIONAL EDUCATION, USA. MY GLOBAL RANK WAS 8 OUT OF 40 TEAMS WHERE I PERFORMED INDIVIDUALLY BEING A ÖNE PERSON" TEAM ACROSS 40+ INDIVIDUALS IN TEAMS. 
...
The objective of this problem is to understand which parameters play an important role in swaying passenger feedback towards a positive scale. You are provided with test data containing the travel data and the survey data of passengers. Both the test data and the train data are collected at the same time and belong to the same population.
